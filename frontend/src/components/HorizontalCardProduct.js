        ...
        {loading
          ? loadingList.map((product, index) => {
              return (
                <div
                  key={index}
                  className="w-full min-w-[300px] md:min-w-[340px] max-w-[300px] md:max-w-[340px] h-48 bg-white rounded-sm shadow flex"
                >
                  <div className="bg-slate-200 h-full  min-w-[140px] md:min-w-[165px] p-2 animate-pulse "></div>
                  <div className="p-4 grid w-full gap-2">
                    ...
                    <div className="flex gap-3 w-full">
                      <p className="text-red-600 font-medium text-ellipsis line-clamp-1 bg-slate-200 w-full animate-pulse rounded-full"></p>
                      <p className="text-slate-400 line-through text-ellipsis line-clamp-1 bg-slate-200 w-full animate-pulse rounded-full"></p>
                    </div>
          ...
          : data.map((product) => {
              return (
                <Link
                  ...
                  className="w-full min-w-[300px] md:min-w-[340px] max-w-[300px] md:max-w-[340px] h-48 bg-white rounded-sm shadow flex"
                >
                  <div className="bg-slate-200 h-full  min-w-[140px] md:min-w-[165px] p-2 ">
                    <img
